...
public class MissingNumberFinderInArrayList {
	public static void main(String[] args) {
		...
		usingCollection(expectedSum,numbers);
		
		List<Integer> intList = Arrays.stream(numbers).boxed().collect(Collectors.toList());
		usingStream(intList,expectedSum);
	}

	private static void usingCollection(Integer expectedSum,int []numbers) {
		Integer missing = 57;
		Integer actualSum=0;
		Integer index = 0;
	...
	private static void usingStream(List<Integer> intList, Integer expectedSum) {
